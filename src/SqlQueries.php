...
class SqlQueries {
  ...
  public function getDistinctHashersByYearQuarter() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, CONCAT_WS('/',YEAR(HASHES.EVENT_DATE),QUARTER(HASHES.EVENT_DATE)) AS THE_TIME_UNIT,
                     COUNT(*) AS THE_COUNT
                FROM HASHINGS
                JOIN HASHES
                  ON HASHINGS.HASH_KY = HASHES.HASH_KY
               ...
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HASHERS.HASHER_NAME, CONCAT_WS('/',YEAR(HASHES.EVENT_DATE),QUARTER(HASHES.EVENT_DATE))) TEMP
       GROUP BY THE_TIME_UNIT
       ORDER BY THE_TIME_UNIT ASC";
  }

  public function getDistinctHashersByYear() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, YEAR(HASHES.EVENT_DATE) AS THE_TIME_UNIT, COUNT(*) AS THE_COUNT
                FROM HASHINGS
                JOIN HASHES
                  ON HASHINGS.HASH_KY = HASHES.HASH_KY
                JOIN HASHERS
                  ON HASHINGS.HASHER_KY = HASHERS.HASHER_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HASHERS.HASHER_NAME, YEAR(HASHES.EVENT_DATE)) TEMP
       GROUP BY THE_TIME_UNIT
       ORDER BY THE_TIME_UNIT ASC";
  }

  public function getDistinctHashersByYearMonth() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, DATE_FORMAT(HASHES.EVENT_DATE,'%Y/%m') AS THE_TIME_UNIT, COUNT(*) AS THE_COUNT
                FROM HASHINGS
                JOIN HASHES
                  ON HASHINGS.HASH_KY = HASHES.HASH_KY
                JOIN HASHERS
                  ON HASHINGS.HASHER_KY = HASHERS.HASHER_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HASHERS.HASHER_NAME, DATE_FORMAT(HASHES.EVENT_DATE,'%Y/%m')) TEMP
       GROUP BY THE_TIME_UNIT
       ORDER BY THE_TIME_UNIT ASC";
  }

  public function getDistinctHashersByMonth() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, DATE_FORMAT(HASHES.EVENT_DATE,'%m') AS THE_TIME_UNIT, COUNT(*) AS THE_COUNT
                FROM HASHINGS
                JOIN HASHES
                  ON HASHINGS.HASH_KY = HASHES.HASH_KY
                JOIN HASHERS
                  ON HASHINGS.HASHER_KY = HASHERS.HASHER_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HASHERS.HASHER_NAME, DATE_FORMAT(HASHES.EVENT_DATE,'%m')) TEMP
       GROUP BY THE_TIME_UNIT
       ORDER BY THE_TIME_UNIT ASC";
  }

  public function getDistinctHaresByYearQuarter() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, CONCAT_WS('/',YEAR(HASHES.EVENT_DATE),QUARTER(HASHES.EVENT_DATE)) AS THE_TIME_UNIT,
                     COUNT(*) AS THE_COUNT
  ...
  public function getDistinctHaresByYear() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, YEAR(HASHES.EVENT_DATE) AS THE_TIME_UNIT, COUNT(*) AS THE_COUNT
                FROM HARINGS
  ...
  public function getDistinctHaresByYearMonth() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, DATE_FORMAT(HASHES.EVENT_DATE,'%Y/%m') AS THE_TIME_UNIT, COUNT(*) AS THE_COUNT
                FROM HARINGS
  ...
  public function getDistinctHaresByMonth() : string {
    return "
      SELECT THE_TIME_UNIT AS THE_VALUE, COUNT(*) AS THE_COUNT
        FROM (SELECT HASHERS.HASHER_NAME, DATE_FORMAT(HASHES.EVENT_DATE,'%m') AS THE_TIME_UNIT, COUNT(*) AS THE_COUNT
                FROM HARINGS
  ...
  public function getPendingHareAnalversaries() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, HASHERS.HASHER_KY, (COUNT(0) + ?) AS THE_COUNT_INCREMENTED,
  ...
  public function getPerKennelHashCountsByYear() : string {
    return "
      SELECT COUNT(*) AS THE_COUNT
        FROM HASHES
        WHERE YEAR(HASHES.EVENT_DATE) = ?
          AND HASHES.KENNEL_KY = ?";
  }

  public function getPerKennelHashersCountByYear() : string {
    return "
      SELECT COUNT(DISTINCT HASHERS.HASHER_KY) AS THE_COUNT
        FROM HASHERS
        JOIN HASHINGS
          ON HASHERS.HASHER_KY = HASHINGS.HASHER_KY
        JOIN HASHES ON HASHINGS.HASH_KY = HASHES.HASH_KY
  ...
  public function getPerKennelHaresCountByYear() : string {
    return "
      SELECT COUNT(DISTINCT HASHERS.HASHER_KY, HARINGS.HARE_TYPE) AS THE_COUNT
        FROM HASHERS
        JOIN HARINGS
          ON HASHERS.HASHER_KY = HARINGS.HARINGS_HASHER_KY
        JOIN HARE_TYPES
  ...
  public function getNewHashersForThisYear() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, (
             SELECT COUNT(*) AS THE_COUNT
               FROM HASHINGS
               JOIN HASHES
                 ON HASHES.HASH_KY = HASHINGS.HASH_KY
              WHERE HASHER_KY = HASH_COUNT_TEMP_TABLE.HASHER_KY
                AND HASHES.KENNEL_KY = HASH_COUNT_TEMP_TABLE.KENNEL_KY ) AS THE_COUNT
        FROM HASHERS
        JOIN (SELECT HASHINGS.HASHER_KY AS HASHER_KY, COUNT(HASHINGS.HASHER_KY) AS HASH_COUNT, HASHES.KENNEL_KY AS KENNEL_KY
                FROM HASHINGS
                JOIN HASHES
                  ON HASHINGS.HASH_KY = HASHES.HASH_KY
               WHERE HASHES.KENNEL_KY = ?
        ...
        JOIN (SELECT HASHINGS.HASHER_KY AS HASHER_KY, MIN(HASHES.EVENT_DATE) AS FIRST_HASH_DATE
               ...
               GROUP BY HASHINGS.HASHER_KY) FIRST_HASH_EVENT_TABLE
          ON HASHERS.HASHER_KY = FIRST_HASH_EVENT_TABLE.HASHER_KY
       WHERE HASH_COUNT_TEMP_TABLE.HASH_COUNT >= 0
         AND DATE_FORMAT(FIRST_HASH_DATE,'%Y') = ?
       ORDER BY THE_COUNT DESC";
  }

  public function getNewHaresForThisYear() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, HASHERS.HASHER_KY AS HASHER_KY,
             FIRST_HASH_EVENT_TABLE.FIRST_HASH_DATE AS FIRST_HASH_DATE, (
             SELECT COUNT(*) AS THE_COUNT
               ...
               JOIN HASHES
                 ON HASHES.HASH_KY = HARINGS.HARINGS_HASH_KY
              WHERE HARINGS_HASHER_KY = HASH_COUNT_TEMP_TABLE.HASHER_KY
                AND HASHES.KENNEL_KY = HASH_COUNT_TEMP_TABLE.KENNEL_KY) AS THE_COUNT
        FROM HASHERS
        JOIN (SELECT HARINGS.HARINGS_HASHER_KY AS HASHER_KY, COUNT(HARINGS.HARINGS_HASHER_KY) AS HASH_COUNT, HASHES.KENNEL_KY AS KENNEL_KY
                FROM HARINGS
                JOIN HARE_TYPES
                  ON HARINGS.HARE_TYPE & HARE_TYPES.HARE_TYPE = HARE_TYPES.HARE_TYPE
                JOIN HASHES
                  ON HARINGS.HARINGS_HASH_KY = HASHES.HASH_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HARINGS.HARINGS_HASHER_KY) HASH_COUNT_TEMP_TABLE
          ON HASHERS.HASHER_KY = HASH_COUNT_TEMP_TABLE.HASHER_KY
        JOIN (SELECT HARINGS.HARINGS_HASHER_KY AS HASHER_KY, MIN(HASHES.EVENT_DATE) AS FIRST_HASH_DATE
                FROM HARINGS
                JOIN HASHES
                  ON HARINGS.HARINGS_HASH_KY = HASHES.HASH_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HARINGS.HARINGS_HASHER_KY) FIRST_HASH_EVENT_TABLE
          ON HASHERS.HASHER_KY = FIRST_HASH_EVENT_TABLE.HASHER_KY
       WHERE HASH_COUNT_TEMP_TABLE.HASH_COUNT >= 1
         AND DATE_FORMAT(FIRST_HASH_DATE,'%Y') = ?
       ORDER BY THE_COUNT DESC";
  }

  public function getNewHaresForThisYearByHareType() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, HASHERS.HASHER_KY AS HASHER_KY, 
             FIRST_HASH_EVENT_TABLE.FIRST_HASH_DATE AS FIRST_HASH_DATE, (
             SELECT COUNT(*) AS THE_COUNT
              ...
              WHERE HARINGS_HASHER_KY = HASH_COUNT_TEMP_TABLE.HASHER_KY
                ...
                AND HASHES.KENNEL_KY = HASH_COUNT_TEMP_TABLE.KENNEL_KY) AS THE_COUNT
        FROM HASHERS
        JOIN (SELECT HARINGS.HARINGS_HASHER_KY AS HASHER_KY, COUNT(HARINGS.HARINGS_HASHER_KY) AS HASH_COUNT,
  ...
  public function getHasherCountsByYear() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME,count(*) AS THE_COUNT
        FROM  HASHERS
        JOIN HASHINGS
          ON HASHERS.HASHER_KY = HASHINGS.HASHER_KY
        JOIN HASHES
  ...
  public function getTotalHareCountsByYear() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, COUNT(*) AS THE_COUNT
        FROM  HASHERS
        JOIN HARINGS
  ...
  public function getHareCountsByYearByHareType() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME,count(*) AS THE_COUNT
        FROM HASHERS
        JOIN HARINGS
  ...
  public function getLowestNumberOfDaysBetweenHarings() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, HASHERS.HASHER_KY AS HASHER_KY, HARING_COUNT_TEMP_TABLE.HARING_COUNT AS HARING_COUNT,
        ...
        FROM HASHERS
        JOIN (SELECT HARINGS.HARINGS_HASHER_KY AS HASHER_KY, COUNT(HARINGS.HARINGS_HASHER_KY) AS HARING_COUNT
                FROM HARINGS
                JOIN HASHES
                  ON HARINGS.HARINGS_HASH_KY = HASHES.HASH_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HARINGS.HARINGS_HASHER_KY) HARING_COUNT_TEMP_TABLE
          ON HASHERS.HASHER_KY = HARING_COUNT_TEMP_TABLE.HASHER_KY
        JOIN (SELECT HARINGS.HARINGS_HASHER_KY AS HASHER_KY, MIN(HASHES.EVENT_DATE) AS FIRST_HARING_DATE
                FROM HARINGS
                JOIN HASHES
                  ON HARINGS.HARINGS_HASH_KY = HASHES.HASH_KY
               WHERE HASHES.KENNEL_KY = ?
        ...
        JOIN (SELECT HARINGS.HARINGS_HASHER_KY AS HASHER_KY, MAX(HASHES.EVENT_DATE) AS LATEST_HARING_DATE
                FROM HARINGS
                JOIN HASHES
                  ON HARINGS.HARINGS_HASH_KY = HASHES.HASH_KY
               WHERE HASHES.KENNEL_KY = ?
               GROUP BY HARINGS.HARINGS_HASHER_KY) LATEST_HARING_EVENT_TABLE
          ON HASHERS.HASHER_KY = LATEST_HARING_EVENT_TABLE.HASHER_KY
       WHERE HARING_COUNT_TEMP_TABLE.HARING_COUNT >= ? 
         AND HARING_COUNT_TEMP_TABLE.HARING_COUNT > 1
       ORDER BY XORDERCOLUMNX XUPORDOWNX";
  }
 
  public function getLowestNumberOfDaysBetweenHaringsByType() : string {
    return "
      SELECT HASHERS.HASHER_NAME AS HASHER_NAME, HASHERS.HASHER_KY AS HASHER_KY, HARING_COUNT_TEMP_TABLE.HARING_COUNT AS HARING_COUNT,
             FIRST_HARING_EVENT_TABLE.FIRST_HARING_DATE AS FIRST_HARING_DATE,
             (SELECT HASH_KY FROM HASHES WHERE KENNEL_KY=? AND EVENT_DATE=FIRST_HARING_DATE) AS FIRST_HARING_KEY,
  ...
  public function getHashEventsWithCounts() : string {
    return "
      SELECT THE_COUNT, HASHES.*, DAYNAME(EVENT_DATE) AS EVENT_DAY_NAME, HASH_TYPES.HASH_TYPE_NAME
        ...
        JOIN (SELECT HASHES.HASH_KY AS THE_HASH_KEY, COUNT(*) AS THE_COUNT
                ...
                JOIN HASHES
                  ON HASHINGS.HASH_KY = HASHES.HASH_KY
               WHERE KENNEL_KY = ?
               GROUP BY HASHES.HASH_KY) AS THE_TEMPORARY_TABLE
          ON HASHES.HASH_KY = THE_TEMPORARY_TABLE.THE_HASH_KEY
       ORDER BY THE_COUNT XUPORDOWNX
      LIMIT XLIMITX";
  }

  public function getGrandtotalNondistinctHashAttendanceByHare() : string {
    return "
      SELECT HASHERS.HASHER_KY AS THE_KEY, HASHERS.HASHER_NAME AS NAME, SUM(TEMPTABLE.THE_COUNT) AS VALUE
        FROM HASHERS
  ...
  public function getGrandtotalDistinctHashAttendanceByHare() : string {
    return "
      SELECT HASHERS.HASHER_KY AS THE_KEY, HASHERS.HASHER_NAME AS NAME, COUNT(DISTINCT HASHINGS.HASHER_KY) AS VALUE
        FROM HASHERS
        JOIN HARINGS
          ON HASHERS.HASHER_KY = HARINGS.HARINGS_HASHER_KY
        JOIN HASHES
  ...
  public function getAllHashingsInAllKennelsForHasher() : string {
    return "
      SELECT KENNELS.KENNEL_ABBREVIATION, HASHES.KENNEL_EVENT_NUMBER, HASHES.HASH_KY
        FROM HASHINGS
        JOIN HASHES
          ON HASHINGS.HASH_KY = HASHES.HASH_KY
        JOIN KENNELS
  ...
  public function getAllHaringsInAllKennelsForHasher() : string {
    return "
      SELECT KENNELS.KENNEL_ABBREVIATION, HASHES.KENNEL_EVENT_NUMBER, HASHES.HASH_KY
        FROM HARINGS
        JOIN HASHES
